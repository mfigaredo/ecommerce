<div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 container py-8">

    <div class="order-2 md:order-1 xl:col-span-3">
    ...
    <div class="order-1 md:order-2 xl:col-span-2">
