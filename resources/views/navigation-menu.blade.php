...
$links = [
    ...
    'admin.brands.index' => [
        'label' => __('Marcas'),
        'route_is' => 'admin.brands.*',
    ],
    'admin.departments.index' => [
        'label' => __('Departamentos'),
        'route_is' => 'admin.departments.*',
    ],
    'admin.users.index' => [
        'label' => __('Usuarios'),
...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @foreach ($links as $r => $link)
                        <x-jet-nav-link href="{{ route($r) }}" :active="request()->routeIs($link['route_is'])">
                            {{ $link['label'] }}
                        </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @foreach ($links as $r => $link)
                <x-jet-responsive-nav-link href="{{ route($r) }}" :active="request()->routeIs($link['route_is'])">
                    {{ $link['label'] }}
                </x-jet-responsive-nav-link>
